...
int main(){
    ...
    ENGINE_ctrl_cmd_string(e, "SO_PATH", "./e_chil.so", 0);
    ENGINE_ctrl_cmd_string(e, "ID", "chil", 0);
    ENGINE_ctrl_cmd_string(e, "LOAD", NULL, 0);

    if (e == NULL){
        printf("Cound not Load e_chil Engine\n");
        exit(1);
    }
    printf("e_chil Engine successfully loaded\n");
